...
## Features
This code runs entirely in the terminal (no GUI yet unfortunately). It first asks the user to select an opponent who can either be another user or one of three difficulties of bots. The three bots are detailed below:
### The easy difficulty bot
The easy difficulty is the simplest. Every turn it takes a random spot
